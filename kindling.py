...
try:
    ...
    f.close()
    httprobe_results = subprocess.run([f"cat /tmp/consolidated_list.tmp | ~/go/bin/httprobe -t 20000 -p http:8080 -p https:8443"], stdout=subprocess.PIPE, stderr=subprocess.DEVNULL, text=True, shell=True)
